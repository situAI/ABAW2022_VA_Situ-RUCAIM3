...
cmd="python train.py --dataset_mode=seq --model=transformer --data_root=$data_root --gpu_ids=$gpu_ids 
...
# bash scripts/train_transformer.sh both affectnet,vggish,wav2vec None /data2/hzp/ABAW_VA_2022/processed_data/ 1 0
